...
def main(wordcloud, wordcloud_combfiles, wordcloud_indfiles, similarity, corpus_docs, query_docs, corpus_docs_append, query_docs_append, all_latest, combined_latest, intraconf_latest, filename, same, name, clustering, cluster_files, knn_clustering, affinity_prop, db, hdb, ward, classification, classification_files, classification_labels):
	...
	if similarity:
		generate_similarity.generate_similarity(corpus_docs, query_docs, corpus_docs_append, query_docs_append, all_latest, combined_latest, intraconf_latest, filename, same, name)
...
if __name__ == '__main__':
	...
	main(args.wordcloud, args.wordcloud_combfiles, args.wordcloud_indfiles, args.similarity, args.corpus_docs, args.query_docs, args.corpus_docs_append, args.query_docs_append, args.all_latest, args.combined_latest, args.intraconf_latest, args.filename, args.same, args.name, args.clustering, args.cluster_files, args.knn_clustering, args.affinity_prop, args.dbscan, args.hdbscan, args.ward, args.classification, args.classification_files, args.classification_labels)